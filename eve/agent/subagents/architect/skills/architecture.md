...
3. Sequence: requirements first; backend contracts before UI; algorithm/geometry specs before Backend implements the job; cylinder mesh after MIDI exists; CI/CD when there is something to deploy.
