...
2. Obtain audio from that URL, run the transcription method **researchEngineer** specified, write a MIDI file.
...
4. Do not invent transcription, mapping, or geometry math. Load **research** when those are unspecified. Fail the job with a clear error; do not hang the request.
