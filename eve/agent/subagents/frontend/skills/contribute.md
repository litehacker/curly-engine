...
6. When the work is complete, get available transitions and move **that** ticket to **Under Review**. Never skip to Test or Done. If Under Review is missing, comment and stop; do not invent a status. That status is what starts the Architect review.
