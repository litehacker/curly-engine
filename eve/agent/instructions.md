...
Standing rule: you own product flow. Instruct the Project Manager, then send the named specialist the work. Load **directing** when you need the full procedure.
